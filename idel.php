                            ...
                            <div class='col-md-6 col-md-offset-6 col-sm-8 col-sm-offset-4'>
                                <div class='single_pakeg_text'>
                                    <div class='pakeg_title'>
                                        <h4>Delete ingredients</h4><br>
                                        <form method='POST' action='ingdel.php'>
                                          <div class='form-group'>
                                              <!--<input type='text' class='form-control' name='text' placeholder='Ingredient name' required=''>-->
                                              <?php
                                              include 'connection.php';
                                              $sql="SELECT * FROM `item`";
                                              $result=mysqli_query($connection, $sql);
                                              while($row=mysqli_fetch_array($result)){
                                    echo "<input type='checkbox' name='checkbox[]' value='".$row['id']."' >".$row['Item'];
                                    echo "<br>";
                                              }
                                              ?>
                                          </div>
